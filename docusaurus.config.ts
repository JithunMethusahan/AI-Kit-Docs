  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/JithunMethusahan/AI-Kit',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Issues',
              href: 'https://github.com/JithunMethusahan/AI-Kit/issues',
            },
      ...
      // This is the copyright text at the very bottom
      copyright: `Copyright © ${new Date().getFullYear()} Jithun Methusahan. Built with Docusaurus.`,
    },
    prism: {
